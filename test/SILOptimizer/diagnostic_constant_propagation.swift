...
func testConvertOverflow() {
  ...
  // IEEE binary32 max value, which is in hexfloat = 0x1.fffffep127
  var _ /*float32_max*/                     : Float32 = (340282346638528859811704183484516925440)
  var _ /*float32_near_max*/                : Float32 = (340282326356119256160033759537265639424)
  var _ /*float32_near_max_but_imprecise*/  : Float32 = (340282326356119256160033759537265639425) // expected-warning {{integer literal '340282326356119256160033759537265639425' is not exactly representable in a 32-bit floating point type}}
